  ...
  return (
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      <Svg width={size} height={size}>
        {/* track */}
        <Circle cx={size/2} cy={size/2} r={r} stroke={colors.ringoutline} strokeWidth={thickness} fill="none" />
        {/* progress */}
        <Circle
          cx={size/2}
          cy={size/2}
      ...
      <AppText variant="ag10" style={{ position: 'absolute', color: colors.subtext }}>{label}</AppText>
    </View>
  );
}
