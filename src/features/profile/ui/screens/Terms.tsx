  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg ?? COLORS.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[cardShadow(false), styles.infoBox, { backgroundColor: theme.infoCardBg ?? '#EFF6FF' }]}>
          <AppText variant="ag10" color={theme.textinfo ?? COLORS.subtext} style={styles.infoText}>
        ...
        <View style={[styles.card, cardShadow(true), { backgroundColor: theme.mealsCard ?? COLORS.card, borderColor: theme.border ?? 'rgba(228,228,228,0.6)' }]}>
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>1. Aceptación de Términos</AppText>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>2. Propósito de la Aplicación</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
            Foodlytics es una herramienta de seguimiento nutricional y de actividad física diseñada para:
          </AppText>
          <View style={styles.list}>
            <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.listItem}>• Registrar y monitorear la ingesta de alimentos</AppText>
            <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.listItem}>• Calcular macronutrientes y calorías</AppText>
            <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.listItem}>• Seguir la actividad física y peso</AppText>
            <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.listItem}>• Proporcionar información nutricional general</AppText>
          </View>

          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>3. No es Asesoramiento Médico</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
            <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.bold}>IMPORTANTE: </AppText>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>4. Precisión de la Información</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>5. Uso de Datos Personales</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>6. Limitación de Responsabilidad</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>7. Condiciones de Salud Específicas</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>8. Menores de Edad</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>9. Cambios en los Términos</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
          ...
          <AppText variant="ag7" color={theme.text ?? COLORS.text} style={styles.h3}>10. Contacto</AppText>
          <AppText variant="ag10" color={theme.subtext ?? COLORS.subtext} style={styles.p}>
